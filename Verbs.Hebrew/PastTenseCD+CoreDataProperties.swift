//
//  PastTenseCD+CoreDataProperties.swift
//  Verbs.Hebrew
//
...
extension PastTenseCD {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<PastTenseCD> {
        return NSFetchRequest<PastTenseCD>(entityName: "PastTenseCD")
    }
