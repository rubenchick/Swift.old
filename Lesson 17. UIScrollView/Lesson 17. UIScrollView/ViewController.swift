...
class ViewController: UIViewController, UIScrollViewDelegate, UITextFieldDelegate {
    ...
    fileprivate func createMiddleView() {
        ...
        //createTextField
        nameTextField = newTextField(defaultText: "Dmitry", position: CGRect(x: 110, y: 6, width: 300, height: 31), tag: 0)
        phoneTextField = newTextField(defaultText: "+7 937 265-00-12", position: CGRect(x: 110, y: 50, width: 300, height: 31), tag: 1)
        emailTextField = newTextField(defaultText: "ilon.mask@gmail.com", position: CGRect(x: 110, y: 94, width: 300, height: 31), tag: 2)
...
//    }
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        if textField.tag == 0 { phoneTextField.becomeFirstResponder() }
            ...
            case 5: textField.resignFirstResponder()
            default:
                break
            }
            return true
