...
//let numberArray = ["One","Two","Three","Four","Five","Six","Seven","Eight","Nine","Ten","Zero"]
//let pronounArray = ["Мне","Тебе (М)","Тебе(Ж)","Ему","Ей","Вам (М)","Вам (Ж)","Им (М)","Им (Ж)","Нам"]
//
//var titleGlobalArray = ["Days Of Week","Numbers","Pronoun"]
//var globalArray = [dayOfWeekArray,numberArray,pronounArray]
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Knowledge_check")
